...
class User_Info_Admin(admin.ModelAdmin):
    list_display = ('userID','membership_level','expiration_date','email','password')
class Task_Info_Admin(admin.ModelAdmin):
    list_display = ('taskID','userID','url','request_time','target_language','voice_selection','mode','status')
