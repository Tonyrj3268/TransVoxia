...
class TaskStatus(models.TextChoices):
    ...
    VOCAL_MERGE_BGMUSIC = "5", _("背景音樂合成中")
    VIDEO_MERGE_PROCESSING = "6", _("影片合成中")
    TASK_STOPPED = "7", _("任務停止，等待用戶繼續")
    TASK_COMPLETED = "8", _("任務完成")
...
class Task(models.Model):
    ...
    voice_selection = models.TextField(null=True, blank=True)
